    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('historial_aportes', models.TextField(blank=True, null=True)),
                ('calculo_pension', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('estado_expediente', models.CharField(default='Pendiente', max_length=100)),
                ('jubilado', models.ForeignKey(limit_choices_to={'user_type': 'jubilado'}, on_delete=django.db.models.deletion.CASCADE, to='onp_app.customuser')),
            ],
        ),
    ]
